...
set_input_delay 4.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {vccd1}]
set_input_delay 4.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {vssd1}]
...
set_output_delay 4.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {vccd1}]
set_output_delay 4.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {vssd1}]
###############################################################################
# Environment
###############################################################################
